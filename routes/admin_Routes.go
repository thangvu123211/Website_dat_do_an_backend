...
func AdminRoutes(r *gin.Engine) {
	...
	admin := r.Group("/admin")
	{
		...
		admin.GET("/export-doanh-thu-thang", middleware.AuthMiddleware(), middleware.RoleMiddleware("admin"), controllers.ExportDoanhThuThang)
		admin.GET("/export-doanh-thu-nam", middleware.AuthMiddleware(), middleware.RoleMiddleware("admin"), controllers.ExportDoanhThuNam)
		...
		admin.GET("/danh-sach-doanh-thu-thang", middleware.AuthMiddleware(), middleware.RoleMiddleware("admin"), controllers.GetDanhSachThangDoanhThu)
		admin.GET("/danh-sach-doanh-thu-nam", middleware.AuthMiddleware(), middleware.RoleMiddleware("admin"), controllers.GetDanhSachNamDoanhThu)
